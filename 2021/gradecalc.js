...
var model = [
    Assignment("Project 1", 100, 20/4, false),
    Assignment("Project 2", 100, 20/4, false),
    Assignment("Project 3", 100, 20/4, false),
    Assignment("Project 4", 100, 20/4, false),
    // Assignment("Project 5", 50, 20/5, false),
    // Assignment("Project Total (450 max)", 450, 20, false),
    Assignment("Exam 1", 60, 20, false),
    Assignment("Exam 2", 60, 20, false),
    // Assignment("Exam 3", 60, 15, false),
    Assignment("Final Exam", 70, 20, false),
    Assignment("Total of Top 12 HW Quizzes", 120, 10, false),
    Assignment("Labs + Surveys", 13, 0, true),
